...
namespace FocasLibrary
{
    ...
    public class FocasLibBase
    {
        ...
        public class IODBPR1
        {
            ...
            public FocasLibBase.IODBPR_data data6 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data7 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data8 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data9 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data10 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data11 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data12 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data13 = new FocasLibBase.IODBPR_data();
            public FocasLibBase.IODBPR_data data14 = new FocasLibBase.IODBPR_data();
        }
