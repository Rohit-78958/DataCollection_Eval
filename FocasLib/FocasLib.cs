...
namespace FocasLibrary
{
    public class FocasLib : FocasLibBase
    {
        ...
        [DllImport("FWLIB32.dll")]
        public static extern short cnc_rddynamic(ushort FlibHndl, short a, short b, IntPtr c);
        ...
        [DllImport("FWLIB32.dll")]
        public static extern short cnc_rdopmsg3(ushort FlibHndl, short type, ref short num, [Out] IntPtr msg);
    }
}